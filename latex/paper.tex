...
\midrule
With CRL & 87.3\% $\pm$ 4.2\% \\
Without CRL & 68.7\% $\pm$ 8.1\% \\
\midrule
Improvement & +27.1\% \\
\bottomrule
\end{tabular}
...
\subsection{Cascade Failure Reduction}

The CRL reduces cascade failure propagation by 63\% through proactive topology modification and load redistribution before failures propagate to dependent agents.
